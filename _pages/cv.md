...
<strong>Design Methods &ndash; <a href="https://lisaover.github.io/portfolio/9800-data-gov-health-status-checks/">Data Governance Health Status Checks</a></strong><br/>
A collaborative project to design Data Governance Health Status Checks to assist the City of Pittsburgh in promoting continuous updating of data inventories, a requirement of the city’s Open Data Ordinance. Major components of the project include procedures for implementing and participating in the Health Status Checks, summaries of each department’s data inventory progress, and an application to prevent data loss from the data inventories. My contribution as a team member was to develop the application, called the Critical Records Program, as a Visual Basic macro that reads the data inventories and reports datasets that are overdue, due, or due soon for updates or that have missing, invalid, or illogical data.

<strong>Data Mining &ndash; <a href="https://lisaover.github.io/portfolio/9801-pitt-topic-modeling/">Digital Humanities Topic Modeling</a></strong><br/>
...
<strong>Metadata &ndash; <a href="https://lisaover.github.io/portfolio/9802-pitt-metadata/">Life During COVID-19 Application Profile and Metadata Schema</a></strong><br/>
...
<strong>Open Data and Government &ndash; <a href="https://lisaover.github.io/portfolio/9803-pitt-open-data/">Census Tracts and Relationship Files</a></strong><br/>
...
### Epidemiology Data Center, University of Pittsburgh<br/>Linking Investigations in Trauma and Emergency Services &ndash; <a href="https://www.litesnetwork.org/">LITES Network</a><br/>
